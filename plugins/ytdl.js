...
cmd({
  ...
  try {
    ...
    const _0x166c67 = await _0x5351f6.sendMessage(_0x14fac3, {
      ...
      'caption': "\n``😜ᴍr moiz🥰`\n\n ─┄┈┈┉┉┉┅┅┅┅┅─┄┅┅┅┅┅┅┅┅┅\n*⟣ ᴍoiz xᴍᴅ sᴏɴɢ ᴅᴏᴡɴʟᴏᴀᴅᴇʀ⟢*\n┅┅┅┅┅┅┅┄┄┄┄┄┄┄┄┅┅┅┅┅┅┅┅┅┅\n-  *ᴏᴜʀ ᴄʜᴀɴɴᴇʟ* ℹ️ ʀᴇᴘʟʏ ʙᴇʟᴏᴡ ᴛʜᴇ ɴᴜᴍʙᴇʀ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ ғᴏʀᴍᴀᴛ\n\n*1   ┃ ᴀᴜᴅɪᴏ sᴏɴɢ🎵*\n*2   ┃  ᴅᴏᴄᴜᴍᴇɴᴛ sᴏɴɢ🗂️*\n\n> © 2025 • ᴍaʟᴠɪɴ xᴍᴅ \n"
    }, {
      'quoted': _0x1439a7
    });
