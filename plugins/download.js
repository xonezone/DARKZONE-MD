      ...
      if (_0x58b051) {
        ...
        if (_0x48db83 === "1.1") {
          await _0x1ac136.sendMessage(_0x231677, {
            ...
            'caption': "*© ᴄʀᴇᴀᴛᴇᴅ ʙʏ darkzone ᴍᴅ*"
          }, {
            'quoted': _0x5ded0a
          });
        } else {
          if (_0x48db83 === "1.2") {
            await _0x1ac136.sendMessage(_0x231677, {
              ...
              'caption': "*© Gᴇɴᴇʀᴀᴛᴇᴅ Bʏ darkzone ᴍᴅ*"
            }, {
              'quoted': _0x5ded0a
            });
          } else {
      ...
      if (_0x4dbcb0) {
        ...
        if (_0x1e75d9 === "1.1") {
          await _0xaf8db8.sendMessage(_0x5eb615, {
            ...
            'caption': "*© Gᴇɴʀᴇʀᴀᴛᴇᴅ Bʏ darkzone ᴍᴅ*"
          }, {
            'quoted': _0x2405c0
          });
        } else {
